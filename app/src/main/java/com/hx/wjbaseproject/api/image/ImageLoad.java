package com.hx.wjbaseproject.api.image;
...
public class ImageLoad {
     ...
     * @param radius      0-25
     */
    public static void loadImage(final Context context, String url, final ImageView imageView, boolean circle, @DrawableRes int placeHolder, final int radius) {
        if (context == null) {
    ...
    public static void loadImage(Context context, String url, @DrawableRes int placeHolder, final LoadResult loadResult){
        if (TextUtils.isEmpty(url)) {
            Logger.e("url is empty");
            if (loadResult != null) {
    ...
    public static void loadImageResult(Context context, String url, final LoadResult loadResult){
        if (TextUtils.isEmpty(url)) {
            Logger.e("url is empty");
            return;
        }
    ...
    public static void loadImage(Context context, String url, final ImageView imageView, boolean circle, @DrawableRes final int placeHolder) {
        if (context == null) {
            Logger.e("context is null");
            return;
        }
    ...
    public static void loadUserAvatar(Context context, String url, ImageView imageView, boolean circle) {
        loadImage(context, url, imageView, circle, R.mipmap.ic_launcher);
    }

    public static void loadGameAvatar(Context context, String url, ImageView imageView) {
        imageView.setScaleType(ImageView.ScaleType.FIT_CENTER);
        loadImage(context, url, imageView, false, R.mipmap.ic_launcher);
    }
    ...
    public static void loadImage(Context context, String url, ImageView imageView, int radius) {
        loadImage(context, url, imageView, false, R.mipmap.ic_launcher, radius);
    }
